# image2 Prompt: 07-03 Platform Engineering
...
Topic:
- Title: 《一图看懂 Platform Engineering》
- Subtitle: 平台工程把复杂基础设施产品化为可自助能力。
- Series: 平台工程与 GitOps
...
2. Core architecture or evolution diagram for Platform Engineering.
