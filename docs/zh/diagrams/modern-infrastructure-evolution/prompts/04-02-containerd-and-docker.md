# image2 Prompt: 04-02 containerd 与 Docker
...
Topic:
- Title: 《一图看懂 containerd 与 Docker》
- Subtitle: Docker 变成体验入口，containerd 成为生产运行时核心。
...
2. Core architecture or evolution diagram for containerd 与 Docker.
