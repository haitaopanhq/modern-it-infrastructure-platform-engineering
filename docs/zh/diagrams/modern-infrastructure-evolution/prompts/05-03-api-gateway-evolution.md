# image2 Prompt: 05-03 API Gateway 演进
...
Topic:
- Title: 《一图看懂 API Gateway 演进》
- Subtitle: 网关从反向代理升级为流量、身份、策略和观测入口。
- Series: 网络与数据面时代
...
2. Core architecture or evolution diagram for API Gateway 演进.
