# image2 Prompt: 04-05 Runtime 与 Kubernetes 的关系
...
Topic:
- Title: 《一图看懂 Runtime 与 Kubernetes 的关系》
- Subtitle: Kubernetes 负责编排，Runtime 才真正创建和约束工作负载。
- Series: 容器 Runtime 与隔离边界
...
2. Core architecture or evolution diagram for Runtime 与 Kubernetes 的关系.
