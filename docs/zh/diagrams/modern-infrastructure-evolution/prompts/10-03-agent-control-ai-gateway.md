# image2 Prompt: 10-03 AI Gateway
...
Topic:
- Title: 《一图看懂 AI Gateway》
- Subtitle: 这里的 AI Gateway 是 Agent 控制面入口，连接会话、工具、技能和审计。
...
2. Core architecture or evolution diagram for AI Gateway.
