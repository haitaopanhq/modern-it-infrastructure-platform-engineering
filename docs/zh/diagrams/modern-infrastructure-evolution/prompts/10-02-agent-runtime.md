# image2 Prompt: 10-02 Agent Runtime
...
Topic:
- Title: 《一图看懂 Agent Runtime》
- Subtitle: Agent Runtime 负责会话、记忆、工具调用、权限和执行边界。
...
2. Core architecture or evolution diagram for Agent Runtime.
