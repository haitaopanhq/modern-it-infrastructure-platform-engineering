# image2 Prompt: 03-02 Kubernetes 为什么统一云原生
...
Topic:
- Title: 《一图看懂 Kubernetes 为什么统一云原生》
- Subtitle: Kubernetes 用声明式 API 统一了云原生应用的控制循环。
- Series: 云平台与控制权迁移
...
2. Core architecture or evolution diagram for Kubernetes 为什么统一云原生.
