# image2 Prompt: 01-05 从 BIOS 到 Kubernetes
...
Topic:
- Title: 《一图看懂 从 BIOS 到 Kubernetes》
- Subtitle: 基础设施控制权从硬件初始化一路上移到声明式控制面。
...
2. Core architecture or evolution diagram for 从 BIOS 到 Kubernetes.
