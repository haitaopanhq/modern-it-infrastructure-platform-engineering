# image2 Prompt: 10-04 Multi-Agent
...
Topic:
- Title: 《一图看懂 Multi-Agent》
- Subtitle: Multi-Agent 的关键不是角色数量，而是任务分解、协调和责任边界。
...
2. Core architecture or evolution diagram for Multi-Agent.
