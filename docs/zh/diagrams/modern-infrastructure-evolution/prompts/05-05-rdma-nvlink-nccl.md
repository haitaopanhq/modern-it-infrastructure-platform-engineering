# image2 Prompt: 05-05 RDMA/NVLink/NCCL
...
Topic:
- Title: 《一图看懂 RDMA/NVLink/NCCL》
- Subtitle: GPU 集群拼的不只是卡数，而是通信效率和拓扑设计。
- Series: 网络与数据面时代
...
2. Core architecture or evolution diagram for RDMA/NVLink/NCCL.
