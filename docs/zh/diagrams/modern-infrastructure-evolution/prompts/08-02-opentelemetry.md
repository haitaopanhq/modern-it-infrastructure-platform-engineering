# image2 Prompt: 08-02 OpenTelemetry
...
Topic:
- Title: 《一图看懂 OpenTelemetry》
- Subtitle: OpenTelemetry 统一了指标、日志、追踪和事件的采集语言。
- Series: 可观测性与治理体系
...
2. Core architecture or evolution diagram for OpenTelemetry.
